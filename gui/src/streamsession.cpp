    ...
    rumble_haptics_on(false)
{
    ...
    if (connect_info.enable_dualsense)
    {
        ...
        // --- MODIFICACAO: DESATIVAR HAPTICS (AUDIO) ---
    ...
    // --- MODIFICACAO: DESATIVAR VIDEO ---
    // O código abaixo conectava o decodificador de vídeo. Comentando, o vídeo é descartado.
/*
#if CHIAKI_LIB_ENABLE_PI_DECODER
    if(pi_decoder)
